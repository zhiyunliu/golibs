...
func TestPathMatch_slash_Match(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "9.2. /*.js", args: args{reg: "/*.js", path: "/aa", spl: "/"}, want: want{match: false}},
		{name: "9.3. /*.js", args: args{reg: "/*.js", path: "/bb.js", spl: "/"}, want: want{match: true}},
		{name: "9.4. /*.js", args: args{reg: "/*.js", path: "/cc.css", spl: "/"}, want: want{match: false}},
		{name: "9.5. /*.js", args: args{reg: "/*.js", path: "/dd/a", spl: "/"}, want: want{match: false}},
		{name: "9.6. /aaa*.js", args: args{reg: "/aaa*.js", path: "/aaabbb.js", spl: "/"}, want: want{match: true}},
		{name: "9.7. /aaa-*.js", args: args{reg: "/aaa-*.js", path: "/aaa-bbbb.js", spl: "/"}, want: want{match: true}},
		{name: "9.8. /aaa-*/bbb/**", args: args{reg: "/api/aaa-*/bbb/**", path: "/api/aaa-bbbb/bbb/aaa/bbb.js", spl: "/"}, want: want{match: true}},

		{name: "10.1. /**/a/**", args: args{reg: "/**/a/**", path: "/a", spl: "/"}, want: want{match: true}},
		{name: "10.2. /**/a/**", args: args{reg: "/**/a/**", path: "/aa/a", spl: "/"}, want: want{match: true}},
		{name: "10.3. /**/a/**", args: args{reg: "/**/a/**", path: "/aa/bb/a", spl: "/"}, want: want{match: true}},
		{name: "10.4. /**/a/**", args: args{reg: "/**/a/**", path: "/a/bb", spl: "/"}, want: want{match: true}},
		{name: "10.5. /**/a/**", args: args{reg: "/**/a/**", path: "/xx/yy/a/zz/qq", spl: "/"}, want: want{match: true}},

		{name: "11.1. /**/a/*/**", args: args{reg: "/**/a/*/**", path: "/a/b", spl: "/"}, want: want{match: true}},
		{name: "11.2. /**/a/*/**", args: args{reg: "/**/a/*/**", path: "/aa/a/b", spl: "/"}, want: want{match: true}},
		{name: "11.3. /**/a/*/**", args: args{reg: "/**/a/*/**", path: "/aa/bb/a/b", spl: "/"}, want: want{match: true}},
		{name: "11.4. /**/a/*/**", args: args{reg: "/**/a/*/**", path: "/a/b/bb", spl: "/"}, want: want{match: true}},
		{name: "11.5. /**/a/*/**", args: args{reg: "/**/a/*/**", path: "/xx/yy/a/b/zz/qq", spl: "/"}, want: want{match: true}},

		{name: "12.1. /**/*/a/**/a", args: args{reg: "/**/*/a/**/a", path: "/b/a/a", spl: "/"}, want: want{match: true}},
		{name: "12.2. /**/*/a/**/a", args: args{reg: "/**/*/a/**/a", path: "/aa/b/a/a", spl: "/"}, want: want{match: true}},
		{name: "12.3. /**/*/a/**/a", args: args{reg: "/**/*/a/**/a", path: "/aa/bb/b/a/xx/a", spl: "/"}, want: want{match: true}},
		{name: "12.4. /**/*/a/**/a", args: args{reg: "/**/*/a/**/a", path: "/b/a/bb/a", spl: "/"}, want: want{match: true}},
		{name: "12.5. /**/*/a/**/a", args: args{reg: "/**/*/a/**/a", path: "/xx/yy/b/a/zz/qq/a", spl: "/"}, want: want{match: true}},

		{name: "13.1. /**/*/a/**/a/*", args: args{reg: "/**/*/a/**/a/*", path: "/b/a/a/c", spl: "/"}, want: want{match: true}},
		{name: "13.2. /**/*/a/**/a/*", args: args{reg: "/**/*/a/**/a/*", path: "/aa/b/a/a/c", spl: "/"}, want: want{match: true}},
		{name: "13.3. /**/*/a/**/a/*", args: args{reg: "/**/*/a/**/a/*", path: "/aa/bb/b/a/a/c", spl: "/"}, want: want{match: true}},
		{name: "13.4. /**/*/a/**/a/*", args: args{reg: "/**/*/a/**/a/*", path: "/b/a/a/c", spl: "/"}, want: want{match: true}},
		{name: "13.5. /**/*/a/**/a/*", args: args{reg: "/**/*/a/**/a/*", path: "/xx/yy/b/a/zz/qq/a/c", spl: "/"}, want: want{match: true}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			m := NewMatch([]string{tt.args.reg}, WithDelimiter[Pattern](tt.args.spl))
